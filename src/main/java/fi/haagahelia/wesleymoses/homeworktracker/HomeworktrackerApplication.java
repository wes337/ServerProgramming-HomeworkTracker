...
public class HomeworktrackerApplication {
	...
	public CommandLineRunner studentDemo(AssignmentRepository arepository, CourseRepository crepository, UserRepository urepository) {
		return (args) -> {
			...
			arepository.save(new Assignment("IT Project", "2012-12-25", "An IT course project.", crepository.findByName("IT").get(0), true, "2012-12-20"));
			arepository.save(new Assignment("Business Assignment", "2018-11-25", "A business course assignment.", crepository.findByName("Business").get(0), false, null));
			arepository.save(new Assignment("Communications Paper", "2019-07-20", "A research paper.", crepository.findByName("Communications").get(0), false, null));
			arepository.save(new Assignment("Law Journal", "2018-12-11", "A law journal.", crepository.findByName("Law").get(0), false, null));
			arepository.save(new Assignment("Test Assignment", "2020-10-30", "A test assignment.", crepository.findByName("IT").get(0), false, null));
			arepository.save(new Assignment("Test Assignment", "2018-10-30", "A test assignment.", crepository.findByName("Law").get(0), false, null));
